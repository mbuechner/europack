 ...
 */
public class DctermsRightsFilter implements FilterInterface {

    final Transformer transformer;

    public DctermsRightsFilter() throws IOException, TransformerConfigurationException {
        final String xsltFileName = "filters/" + DctermsRightsFilter.class.getSimpleName() + ".xsl";
    ...
    /**
     * ore:Aggregation/dcterms:rights - Löschen
     *
     * @param ed
     * @throws Exception
     */
    ...
    public String getDescription() {
        return "ore:Aggregation/dcterms:rights - Löschen";
    }
    ...
    public String getName() {
        return DctermsRightsFilter.class.getSimpleName();
    }
