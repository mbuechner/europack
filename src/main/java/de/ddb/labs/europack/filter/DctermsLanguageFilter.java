 ...
 */
public class DctermsLanguageFilter implements FilterInterface {

    final Transformer transformer;

    public DctermsLanguageFilter() throws IOException, TransformerConfigurationException {
        final String xsltFileName = "filters/" + DctermsLanguageFilter.class.getSimpleName() + ".xsl";
    ...
    /**
     * edm:ProvidedCHO/dcterms:language - Löschen
     *
     * @param ed
     * @throws Exception
     */
    ...
    public String getDescription() {
        return "edm:ProvidedCHO/dcterms:language - Löschen";
    }
    ...
    public String getName() {
        return DctermsLanguageFilter.class.getSimpleName();
    }
