 ...
 */
public class DdbHierarchyPositionFilter implements FilterInterface {

    private final Transformer transformer;

    public DdbHierarchyPositionFilter() throws IOException, TransformerConfigurationException {
        final String xsltFileName = "filters/" + DdbHierarchyPositionFilter.class.getSimpleName() + ".xsl";
    ...
    /**
     * edm:ProvidedCHO/ddb:hierarchyPosition - Löschen
     *
     * @param ed
     * @throws Exception
     */
    ...
    public String getDescription() {
        return "edm:ProvidedCHO/ddb:hierarchyPosition - Löschen";
    }
    ...
    public String getName() {
        return DdbHierarchyPositionFilter.class.getSimpleName();
    }
