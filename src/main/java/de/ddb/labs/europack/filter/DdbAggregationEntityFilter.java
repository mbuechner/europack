...
public class DdbAggregationEntityFilter implements FilterInterface {
    ...
    /**
     * edm:ProvidedCHO/ddb:aggregationEntity - Löschen
     *
     * @param ed
     * @throws Exception
     */
    ...
    public String getDescription() {
        return "edm:ProvidedCHO/ddb:aggregationEntity - Löschen";
    }
    ...
    public String getName() {
        return DdbAggregationEntityFilter.class.getSimpleName();
    }
