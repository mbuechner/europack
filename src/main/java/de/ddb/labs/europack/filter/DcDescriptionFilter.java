 ...
 */
public class DcDescriptionFilter implements FilterInterface {

    final Transformer transformer;

    public DcDescriptionFilter() throws IOException, TransformerConfigurationException {
        final String xsltFileName = "filters/" + DcDescriptionFilter.class.getSimpleName() + ".xsl";
    ...
    /**
     * edm:ProvidedCHO/dc:description - Option: Löschen/nicht löschen
     *
     * @param ed
     * @throws Exception
     */
    ...
    public String getDescription() {
        return "edm:ProvidedCHO/dc:description - Option: Löschen/nicht löschen";
    }
    ...
    public String getName() {
        return DcDescriptionFilter.class.getSimpleName();
    }
