/*
 * Source: https://bitbucket.org/kentcdodds/java-helper-library/src/master/src/com/kentcdodds/javahelper/extras/MessageConsole.java
 */
 ...
 * of the console
 *
 * You can limit the number of lines to hold in the Document See
...
public class MessageConsole {
    ...
    public MessageConsole(JTextComponent textComponent, JCheckBoxMenuItem autoScroll) {
        this(textComponent, true, autoScroll);
    }
     ...
     */
    public MessageConsole(JTextComponent textComponent, boolean isAppend, JCheckBoxMenuItem autoScroll) {
    ...
    public void redirectOut(Color textColor, PrintStream printStream) {
        ...
        System.setOut(new PrintStream(cos, true, Charset.defaultCharset()));
    }
    ...
    public void redirectErr(Color textColor, PrintStream printStream) {
        final ConsoleOutputStream cos = new ConsoleOutputStream(textColor, printStream);
        System.setErr(new PrintStream(cos, true, Charset.defaultCharset()));
    }
	 ...
	 *  will be appended or inserted into the Document
        ...
        @Override
        public void flush() {
            final String message = toString(Charset.defaultCharset());
